...
% function Y = dwtgroup(X,n)
% Regroup the rows and columns of X, such that an n-level DWT image
% composed of separate subimages is regrouped into 2^n x 2^n blocks of
% coefs from the same spatial region (like the DCT).
