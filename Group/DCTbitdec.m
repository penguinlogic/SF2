function Zi = DCTbitdec()

% based on JPEGDEC.M
% Simplified JPEG decoder simulation.
% Nick Kingsbury, Dec 1994.
...
disp('Inverse quantising'); Z=quant2(Zq,stp,rise);

C8=dctmat(N);
disp('Inverse DCT'); Zi=colxfm(colxfm(Z',C8')',C8');
